...
MODEL_PATH = r"D:\python\dmx\cdtest\tools\whisper_models\models--Systran--faster-whisper-large-v3\snapshots\large-v3"
AUDIO_DIR = Path(r"D:\python\dmx\cdtest\docs\听书测试物料\mp3\梦成接口_XR3_英西")
TXT_DIR = Path(r"D:\python\dmx\cdtest\docs\听书测试物料\txt文本")
OUT_JSON = Path(r"D:\python\dmx\cdtest\docs\听书测试物料\mp3\梦成接口_XR3_英西\accuracy_spotcheck.json")
OUT_PARTIAL = Path(r"D:\python\dmx\cdtest\docs\听书测试物料\mp3\梦成接口_XR3_英西\accuracy_spotcheck_partial.json")
